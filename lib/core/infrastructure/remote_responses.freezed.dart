...
class _$_NoModified<T> extends _NoModified<T> {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_NoModifiedCopyWith<T, _$_NoModified<T>> get copyWith =>
      __$$_NoModifiedCopyWithImpl<T, _$_NoModified<T>>(this, _$identity);
...
abstract class _NoModified<T> extends RemoteResponse<T> {
  const factory _NoModified({required final int maxPage}) = _$_NoModified<T>;
